...
async function postImage(url, image, data) {
  ...
  } else if (!isSuccessful && data.onError) {
  ...
  return (
    <div className={classNames('image-selector', styles.selector, className)}>
      ...
      {displayUrl && (
        <div
          className={classNames(
            'image-selector__value-display',
            styles.selector__display
          )}
        >
          ...
          <Button
            className="image-selector__show-controls"
            btnStyle="accent"
      ...
      {!displayUrl && !state.isLoading && (
        <div
          className={classNames('image-selector__controls', styles.controls)}
        >
          <div
            className={classNames(
              'image-selector__url-uploader',
              isFocused && 'image-selector__url-uploader--focused',
          ...
          >
            ...
            <Button
              className={classNames(
                'image-selector__upload-url',
                styles.selector__urlButton
              )}
              btnStyle="primary"
