...
class Calendar extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className={classNames('calendar-view-controls')}>
          <Button
        ...
        <div className={classNames('calendar-view')}>
          {isMonthView &&
            viewHeaders.map((header) => (
              <div
                key={header}
                className={classNames('calendar-view-option', 'day', 'header')}
              >
                {header}
              </div>
            ))}
          {viewOptions.map((option) => {
            ...
            return (
              <div
                key={option.key}
                className={classNames('calendar-view-option', {
                  day: isMonthView,
                  month: !isMonthView,
